	...
	<div class="hero-text white text-center">
		...
		{:else}
			...
			<p class="light-gray mb-l">
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex nisi modi ut quia dignissimos
				eveniet porro quo rem dolor, iure a hic dolores sit harum incidunt officiis ullam vitae
				minus.
			</p>
			<Button>Purchase book for $10</Button>
		{/if}
	</div>
</section>
